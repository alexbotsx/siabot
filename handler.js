...
global.dfail = (type, m, conn) => {
    const msg = {
        rowner: `🚩 Hola, este comando solo puede ser utilizado por *SIABOT*.`,
        owner: `👤 Usuario, Este Comando Solo Puede Ser Utilizado Por *SIABOT*.`,
        mods: `🤚🏻 Hola, este comando solo puede ser utilizado por *SIABOT*.`,
